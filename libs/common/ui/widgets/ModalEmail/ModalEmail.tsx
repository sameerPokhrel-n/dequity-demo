...
export const ModalEmail = ({data, dataTheme}:{data:any,dataTheme:any}) => {
    ...
    return (
        <div >
            <Modal id="theme" className={dataTheme} dir={router.locale == "ar" ? "rtl" : "ltr"}  show={modalShow} onHide={handleCloseModal} contentClassName={theme} onKeyDown={handleKeyDown}>
            ...
            <Modal id="theme" className={dataTheme} dir={router.locale == "ar" ? "rtl" : "ltr"}  show={modalThanksShow} contentClassName={theme} onHide={handleCloseModalThanks}>
