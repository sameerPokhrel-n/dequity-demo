        ...
        <div className={styles._404_div}>
            <div className="container">
                ...
                c6.755-0.61,20.546-0.608,41.785,5.087s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z"/>
                                ...
                                <g id="planet">
                                    <circle fill="none" stroke={color} stroke-width="3" stroke-miterlimit="10"
                                            cx="572.859" cy="108.803"
                                            r="90.788"/>

                                    <circle id="craterBig" fill="none" stroke={color} stroke-width="3"
                                            stroke-miterlimit="10" cx="548.891"
                                            cy="62.319" r="13.074"/>

                                    <circle id="craterSmall" fill="none" stroke={color} stroke-width="3"
			...
			c0-3.378-15.347-4.988-40.243-7.225"/>
                                    ...
                                    <path id="ringShadow" opacity="0.5" fill="none" stroke={color} stroke-width="3"
                                ...
                                <g id="stars">
                                    <g id="starsBig">
                                        <g>
                                            ...
                                            <line fill="none" stroke={color} stroke-width="3" stroke-linecap="round"
                                    ...
                                    <g id="circlesBig">
                                        ...
                                        <circle fill="none" stroke={color} stroke-width="3" stroke-linecap="round"
                                                stroke-miterlimit="10"
